...
inline const std::vector<Preset>& factoryPresets()
{
    ...
    // 808: a real 808 is a sine that drops fast from a higher pitch (the knock), then rings out on its fundamental and
    // decays to nothing (no sustain), with just enough clipping to be heard on small speakers. Legato slides.
    // Macro 1 GRIT morphs the body into the saturated end of the table, Macro 2 DARK closes the filter,
    // Macro 3 DIRT pushes the distortion.
    static const PresetValues base808
    {
        { "aTable", 3 }, { "aPos", 0.0f }, { "aLevel", 0.9f }, { "retrig", 1 },
        { "dropAmt", 24 }, { "dropTime", 0.04f }, { "mode", 2 }, { "glide", 0.09f }, { "bendRange", 12 },
        { "ampA", 0.0f }, { "ampD", 2.4f }, { "ampS", 0.0f }, { "ampR", 0.25f },
        { "fltType", 1 }, { "cutoff", 20000 },
        { "distType", 3 }, { "distDrive", 0.25f }, { "distMix", 1 },
    ...
    static const std::vector<Preset> basePresets
    {
        ...
        //================================================================ 808
        { "Rager 808", "808", with (base808, { { "aPos", 0.2f }, { "dropAmt", 24 }, { "dropTime", 0.045f }, { "ampD", 2.6f },
            { "distType", 0 }, { "distDrive", 0.45f }, { "ott", 0.25f } }), m808 },
        { "Sicko Slide", "808", with (base808, { { "aPos", 0.12f }, { "dropAmt", 12 }, { "dropTime", 0.03f }, { "glide", 0.14f },
            { "ampD", 4.0f }, { "ampR", 0.3f }, { "mod1Amt", 0.6f }, { "distDrive", 0.35f } }), m808 },
        { "Astro Sub", "808", with (base808, { { "aLevel", 0.95f }, { "dropAmt", 12 }, { "dropTime", 0.025f }, { "glide", 0.08f },
            { "ampD", 2.2f }, { "ampR", 0.2f }, { "mod1Amt", 0.3f }, { "distType", 0 }, { "distDrive", 0.15f }, { "distMix", 0.6f } }), m808 },
        { "Night Growl 808", "808", with (base808, { { "aPos", 0.25f }, { "aLevel", 0.85f },
            { "bOn", 1 }, { "bTable", 5 }, { "bPos", 0.2f }, { "bLevel", 0.22f }, { "bOct", 1 }, { "glide", 0.1f }, { "ampD", 2.6f },
        ...
        { "Blown Speaker 808", "808", with (base808, { { "aPos", 0.3f }, { "dropAmt", 28 }, { "dropTime", 0.035f }, { "glide", 0.07f },
            { "ampD", 2.2f }, { "ampR", 0.2f }, { "distType", 1 }, { "distDrive", 0.7f }, { "ott", 0.4f } }), m808 },
        { "Knock 808", "808", with (base808, { { "aPos", 0.1f }, { "subOn", 1 }, { "subShape", 3 }, { "subOct", 0 }, { "subLevel", 0.3f },
            { "dropAmt", 36 }, { "dropTime", 0.018f }, { "mode", 1 }, { "glide", 0 },
            { "ampD", 1.1f }, { "ampR", 0.1f }, { "distDrive", 0.5f } }), m808 },
        { "Drill Slide 808", "808", with (base808, { { "aPos", 0.15f }, { "dropAmt", 19 }, { "dropTime", 0.03f }, { "glide", 0.11f },
            { "ampD", 4.5f }, { "ampR", 0.3f }, { "distDrive", 0.45f }, { "ott", 0.2f } }), m808 },
        { "Clean Long 808", "808", with (base808, { { "aTable", 0 }, { "aPos", 0.0f }, { "dropAmt", 12 }, { "dropTime", 0.03f },
            { "ampD", 5.0f }, { "ampR", 0.35f }, { "mod1Amt", 0.25f }, { "distType", 0 }, { "distDrive", 0.1f }, { "distMix", 0.4f } }), m808 },
        { "Punchy Trap 808", "808", with (base808, { { "subOn", 1 }, { "subShape", 3 }, { "subOct", 0 }, { "subLevel", 0.3f },
            { "dropAmt", 30 }, { "dropTime", 0.022f }, { "ampD", 1.6f }, { "distDrive", 0.6f }, { "ott", 0.3f } }), m808 },
        { "Phonk 808", "808", with (base808, { { "aPos", 0.4f }, { "dropAmt", 24 }, { "dropTime", 0.03f }, { "glide", 0.06f },
            { "ampD", 1.8f }, { "cutoff", 6000 }, { "distType", 1 }, { "distDrive", 0.85f }, { "ott", 0.5f } }), m808 },
        { "Rolling 808", "808", with (base808, { { "aPos", 0.2f }, { "glide", 0.12f }, { "cutoff", 800 }, { "fltKey", 0.6f },
            { "ampD", 3.2f }, { "mod2Amt", 0.8f }, { "distType", 0 }, { "distDrive", 0.5f }, { "distMix", 0.9f } }),
          { "GRIT", "OPEN", "DIRT", "MACRO 4" } },
        { "Moog 808", "808", with (base808, { { "aPos", 0.1f }, { "bOn", 1 }, { "bTable", 0 }, { "bPos", 0.66f }, { "bLevel", 0.22f },
            { "cutoff", 420 }, { "res", 0.25f }, { "fltEnv", 0.35f }, { "fltKey", 0.4f }, { "modD", 0.4f }, { "modS", 0.15f }, { "ampD", 2.6f },
            { "mod2Amt", 0.7f }, { "distType", 0 }, { "distDrive", 0.3f }, { "distMix", 0.7f } }),
          { "GRIT", "OPEN", "DIRT", "MACRO 4" } },
        { "Hollow 808", "808", with (base808, { { "aTable", 12 }, { "aPos", 0.3f }, { "dropAmt", 17 },
            { "ampD", 2.6f }, { "distType", 0 }, { "distDrive", 0.35f }, { "distMix", 0.8f } }), m808 },
        { "Glide Boom 808", "808", with (base808, { { "aPos", 0.1f }, { "glide", 0.24f }, { "dropAmt", 12 },
            { "ampD", 6.0f }, { "ampR", 0.4f }, { "distDrive", 0.3f } }), m808 },
        { "Reese 808", "808", with (base808, { { "aPos", 0.15f }, { "bOn", 1 }, { "bTable", 0 }, { "bPos", 0.66f }, { "bUni", 3 }, { "bDetune", 0.22f },
            { "bLevel", 0.22f }, { "cutoff", 650 }, { "ampD", 3.0f }, { "mod2Amt", 0.8f }, { "distType", 0 }, { "distDrive", 0.4f }, { "distMix", 0.8f } }),
          { "GRIT", "OPEN", "DIRT", "MACRO 4" } },
        { "Bitcrushed 808", "808", with (base808, { { "aPos", 0.2f }, { "distType", 5 }, { "distDrive", 0.45f }, { "distMix", 0.6f }, { "ott", 0.3f } }), m808 },
        { "Jersey Bounce 808", "808", with (base808, { { "aPos", 0.15f }, { "dropAmt", 30 }, { "dropTime", 0.025f }, { "mode", 1 }, { "glide", 0 },
            { "ampD", 0.7f }, { "ampR", 0.08f }, { "distDrive", 0.55f }, { "ott", 0.35f } }), m808 },
        { "UK Drill Bounce", "808", with (base808, { { "aPos", 0.15f }, { "glide", 0.08f }, { "dropAmt", 19 }, { "dropTime", 0.035f },
            { "ampD", 2.8f }, { "distDrive", 0.5f } }), m808 },
        { "Memphis 808", "808", with (base808, { { "aPos", 0.25f }, { "dropAmt", 24 }, { "ampD", 2.0f }, { "cutoff", 5000 },
            { "distType", 5 }, { "distDrive", 0.3f }, { "distMix", 0.45f }, { "ott", 0.2f } }), m808 },
        { "Plugg 808", "808", with (base808, { { "aTable", 0 }, { "aPos", 0.0f }, { "dropAmt", 12 }, { "glide", 0.1f },
            { "ampD", 4.5f }, { "distType", 2 }, { "distDrive", 0.2f }, { "distMix", 0.35f },
            { "verbMix", 0.08f }, { "verbSize", 0.4f } }), m808 },
        { "Stadium 808", "808", with (base808, { { "aPos", 0.2f }, { "ampD", 3.2f }, { "ott", 0.45f },
            { "distType", 0 }, { "distDrive", 0.4f }, { "verbMix", 0.1f }, { "verbSize", 0.55f } }), m808 },
        { "Tough 808", "808", with (base808, { { "aPos", 0.3f }, { "dropAmt", 28 }, { "dropTime", 0.03f },
            { "ampD", 2.2f }, { "distType", 4 }, { "distDrive", 0.35f }, { "distMix", 0.5f }, { "ott", 0.3f } }), m808 },
        { "Rage Slide 808", "808", with (base808, { { "aPos", 0.35f }, { "glide", 0.16f }, { "dropAmt", 17 },
            { "ampD", 4.5f }, { "distType", 1 }, { "distDrive", 0.6f }, { "ott", 0.4f } }), m808 },
        { "TR Boom", "808", with (base808, { { "aTable", 0 }, { "dropAmt", 7 }, { "dropTime", 0.06f }, { "mode", 1 }, { "glide", 0 },
            { "ampD", 1.4f }, { "ampR", 0.9f }, { "distType", 0 }, { "distDrive", 0.08f }, { "distMix", 0.5f } }), m808 },
        { "Long Tail 808", "808", with (base808, { { "aPos", 0.08f }, { "dropAmt", 19 }, { "dropTime", 0.035f },
            { "ampD", 7.0f }, { "ampR", 0.5f }, { "distDrive", 0.35f } }), m808 },
        ...
        { "Deep Groove Sub", "Sub", with (bassBase, { { "aTable", 3 }, { "aPos", 0.15f }, { "glide", 0.03f },
        ...
        { "Reese Wide", "Reese", with (bassBase, { { "aTable", 0 }, { "aPos", 0.66f }, { "aUni", 5 }, { "aDetune", 0.35f }, { "aBlend", 0.7f },
            ...
            { "chorusMix", 0.25f }, { "ott", 0.3f }, { "distType", 0 }, { "distDrive", 0.25f }, { "distMix", 0.4f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.45f }, { "subFilter", 0  }, { "eqLow", 2.5f } }), mBass },
        { "Neuro Reese", "Reese", with (bassBase, { { "aTable", 0 }, { "aPos", 0.66f }, { "aUni", 7 }, { "aDetune", 0.45f }, { "aBlend", 0.8f },
            ...
            { "ott", 0.5f }, { "distType", 0 }, { "distDrive", 0.35f }, { "distMix", 0.5f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.60f }, { "subFilter", 0  }, { "eqLow", 5.0f } }), mBass },
        ...
        { "Dark Reese", "Reese", with (bassBase, { { "aTable", 0 }, { "aPos", 0.66f }, { "aUni", 7 }, { "aDetune", 0.3f },
            ...
            { "ott", 0.4f }, { "distType", 0 }, { "distDrive", 0.3f }, { "distMix", 0.5f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.45f }, { "subFilter", 0  }, { "eqLow", 2.5f } }), mBass },
        ...
        { "Techno Reese", "Reese", with (bassBase, { { "aTable", 0 }, { "aPos", 0.66f }, { "aUni", 3 }, { "aDetune", 0.2f },
            ...
            { "distType", 0 }, { "distDrive", 0.45f }, { "distMix", 0.7f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.60f }, { "subFilter", 0  }, { "eqLow", 3.0f } }), mBass },
        { "Detuned Saws", "Reese", with (bassBase, { { "aTable", 0 }, { "aPos", 0.66f }, { "aUni", 7 }, { "aDetune", 0.55f }, { "aBlend", 0.9f },
            { "mode", 2 }, { "glide", 0.04f }, { "ampS", 1.0f }, { "fltType", 1 }, { "cutoff", 2400 }, { "chorusMix", 0.3f }, { "width", 1.3f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.60f }, { "subFilter", 0  }, { "eqLow", 3.0f } }), mBass },
        { "Phase Reese", "Reese", with (bassBase, { { "aTable", 0 }, { "aPos", 0.66f }, { "aUni", 5 }, { "aDetune", 0.2f },
            ...
            { "mod6Src", 1 }, { "mod6Dest", 13 }, { "mod6Amt", 0.15f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.45f }, { "subFilter", 0  }, { "eqLow", 2.5f } }), mBass },
        ...
        { "Growl Monster", "Growl & Wobble", with (wobBase, { { "aTable", 5 }, { "aPos", 0.3f }, { "aUni", 3 }, { "aDetune", 0.12f },
            ...
            { "distType", 2 }, { "distDrive", 0.35f }, { "distMix", 0.5f }, { "ott", 0.6f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.55f }, { "subFilter", 0  }, { "eqLow", 5.0f } }), mWob },
        ...
        { "Wub 1/4T", "Growl & Wobble", with (wobBase, { { "aTable", 0 }, { "aPos", 0.66f }, { "aUni", 3 }, { "aDetune", 0.15f },
            ...
            { "mod1Dest", 8 }, { "mod1Amt", 0.65f }, { "mod2Src", 0  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.45f }, { "subFilter", 0  }, { "eqLow", 4.0f } }), mWob },
        { "Metal Growl", "Growl & Wobble", with (wobBase, { { "aTable", 10 }, { "aPos", 0.3f }, { "aUni", 2 }, { "aDetune", 0.1f },
            { "cutoff", 2500 }, { "res", 0.2f }, { "lfo1Shape", 1 }, { "lfo1Sync", 8 }, { "mod3Amt", 0.5f }, { "ott", 0.6f }, { "distType", 2  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.50f }, { "subFilter", 0  }, { "eqLow", 4.5f } }), mWob },
        { "Fold Wobble", "Growl & Wobble", with (wobBase, { { "aTable", 8 }, { "aPos", 0.3f }, { "aUni", 2 }, { "aDetune", 0.08f },
            { "cutoff", 2000 }, { "res", 0.15f }, { "mod1Amt", 0.35f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.45f }, { "subFilter", 0  }, { "eqLow", 3.5f } }), mWob },
        ...
        { "Sync Wobble", "Growl & Wobble", with (wobBase, { { "aTable", 0 }, { "aPos", 0.66f }, { "aWarp", 1 }, { "aWarpAmt", 0.2f },
            { "lfo1Sync", 7 }, { "mod1Dest", 3 }, { "mod1Amt", 0.5f }, { "mod3Dest", 3 }, { "mod3Amt", 0.4f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.45f }, { "subFilter", 0  }, { "eqLow", 3.0f } }), mWob },
        ...
        { "Formant Growl", "Growl & Wobble", with (wobBase, { { "aTable", 0 }, { "aPos", 0.66f }, { "aUni", 3 }, { "aDetune", 0.12f },
            ...
            { "mod1Dest", 8 }, { "mod1Amt", 0.6f }, { "mod2Src", 0 }, { "ott", 0.6f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.45f }, { "subFilter", 0  }, { "eqLow", 4.0f } }), mWob },
        { "Chainsaw", "Growl & Wobble", with (wobBase, { { "aTable", 11 }, { "aPos", 0.7f }, { "aUni", 5 }, { "aDetune", 0.2f },
            ...
            { "ott", 0.7f }, { "distType", 1 }, { "distMix", 0.6f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.55f }, { "subFilter", 0  }, { "eqLow", 5.0f } }), mWob },
        ...
        { "Slap FM Bass", "Pluck Bass", with (bassBase, { { "aTable", 12 }, { "aPos", 0.3f }, { "aWarp", 6 }, { "aWarpAmt", 0.05f },
            ...
            { "mod1Src", 3 }, { "mod1Dest", 3 }, { "mod1Amt", 0.6f }, { "mod5Src", 4 }, { "mod5Dest", 3 }, { "mod5Amt", 0.2f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.50f }, { "subFilter", 0  }, { "eqLow", 3.0f } }), mBass },
        { "Stab Bass", "Pluck Bass", with (bassBase, { { "aTable", 2 }, { "aPos", 0.2f }, { "aUni", 3 }, { "aDetune", 0.12f },
            { "bOn", 1 }, { "bTable", 0 }, { "bPos", 0.66f }, { "bOct", -1 }, { "bLevel", 0.4f },
            { "ampD", 0.22f }, { "ampS", 0 }, { "cutoff", 600 }, { "res", 0.2f }, { "fltEnv", 0.5f }, { "modD", 0.12f }, { "modS", 0 }, { "ott", 0.3f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.40f }, { "subFilter", 0  }, { "eqLow", 3.0f } }), mBass },
        ...
        { "Comb Pluck Bass", "Pluck Bass", with (bassBase, { { "aTable", 0 }, { "aPos", 0.66f }, { "ampD", 0.4f }, { "ampS", 0 },
            { "fltType", 6 }, { "cutoff", 110 }, { "res", 0.8f }, { "fltKey", 1.0f }, { "fltEnv", 0.2f }, { "modD", 0.1f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.45f }, { "subFilter", 0  }, { "eqLow", 3.0f } }), mBass },
        ...
        { "Garage Bass", "House Bass", with (bassBase, { { "aTable", 1 }, { "aPos", 0.15f }, { "mode", 2 }, { "glide", 0.05f },
            ...
            { "cutoff", 700 }, { "res", 0.2f }, { "fltEnv", 0.3f }, { "modD", 0.2f }, { "subOn", 1 }, { "subOct", -1 }, { "subLevel", 0.45f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.40f }, { "subFilter", 0  }, { "eqLow", 3.0f } }), mBass },
        ...
        { "Rolling Groove Bass", "House Bass", with (bassBase, { { "aTable", 12 }, { "aPos", 0.5f }, { "mode", 2 }, { "glide", 0.05f },
        ...
        { "Minimal Blip", "House Bass", with (bassBase, { { "aTable", 0 }, { "aPos", 0 }, { "aWarp", 6 }, { "aWarpAmt", 0.0f },
            ...
            { "mod1Src", 3 }, { "mod1Dest", 3 }, { "mod1Amt", 0.4f }, { "dlyTime", 2 }, { "dlyFb", 0.3f }, { "dlyMix", 0.15f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.45f }, { "subFilter", 0  }, { "eqLow", 3.5f } }), mBass },
        ...
        { "Chicago Acid", "House Bass", with (bassBase, { { "aTable", 2 }, { "aPos", 0.0f }, { "glide", 0.07f },
            ...
            { "distType", 0 }, { "distDrive", 0.35f }, { "distMix", 0.5f  }, { "subOn", 1 }, { "subShape", 0 }, { "subOct", 0 }, { "subLevel", 0.35f }, { "subFilter", 0 } }), mBass },
